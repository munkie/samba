...
class SambaTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testClientMethod()
    {
        ...
        $sambaMock = $this->getSambaClientMock(array('getProcessResource', 'fgets', 'closeProcessResource'));
...
EOF;
        ...
        $this->setExpectedException('\\Samba\\SambaWrapperException');
...
EOF;
        ...
        $sambaMock = $this->getSambaWrapperMock(array('getProcessResource', 'fgets', 'closeProcessResource'));
